...
*/
// CODE HERE
// Step 1: Define the function(s) we want to be able to perform,
// Step 2: Which will then get used INSIDE of the higher function,
  // Step a: process & clean the inputs
  // Step b: decide to pass them to the function from Step 1
    // or return a default / custom error
// === Step 1 ===
...
const multiply = (num1, num2, callback) => {
  if(+num1 && +num2) {
    num1 = +num1;
    num2 = +num2;
    // continue and send the numbers to their calculations
    return callback(num1 * num2);
  } else {
    return 'input numbers for multiplication.'
  }
};
...
// === this could be fixed for the index value
// CODE HERE 
const each = (arr, cb) => {
  arr.forEach(function(element, i, arr) {
    return cb(element, i, arr);
  });
}
/*
...
*/
// CODE HERE
const eachName = each(names, results => {
  console.log(`The item at index ${results}, `)
})
