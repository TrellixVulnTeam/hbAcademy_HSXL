...
/*
    ...
    the value. // DONE
    // our notes
    const - once a variable is set as const, we are not able to update.
    var - globally scoped
    let - locally scoped
*/
// CODE HERE
let speed = 25;
console.log(`your current speed is basic of: ${speed}`); // BEFORE NEW ASSIGNMENT
///// PROBLEM 2 /////
/*
...
*/
// CODE HERE
speed = 500; // was 25, now is 500
console.log("We have reassigned the value");
// after the new assignment
console.log(`we updated the speed to PLATINUM of: ${speed}`);
