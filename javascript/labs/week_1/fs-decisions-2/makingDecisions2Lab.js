...
*/
//Code Here
let someNum = myFavoriteNumbers[4]; // fifth value, did they mean not computer sciency indices way?
// console.log(someNum);
...
//Code Here
  ...
  //   console.log('There are not enough elements in this array'); // there are less than 7 elements.
  // } else if (myFavoriteNumbers.length === 7) {
  //   console.log('There are exactly 7 elements in this array'); // there  are exactly 7 elements.
  // } else {
  //   someNum = myFavoriteNumbers[6]; // there are more than 7 elements in this array.
  //   console.log(someNum); // expects the 7th element in the array, if it exists.
  // }
...
//Code Here
// OUR CASE WE ARE LOOKING FOR IS 'B', WHICH IS STORED IN the variable of letterGrade,
switch(letterGrade) {
  // if you see A do this here
  case 'A':
    console.log("===================");
  ...
  case 'F':
    ...
    console.log("===================");
    break;
  // THIS IS THE ELSE STATEMENT, for when the defined cases are not found.
  default:
    console.log("===================");
...
for(let i = 1; i <= desiredNumber; i++) {
  if(i % 15 === 0){
    console.log('devmountainWOOHOOO');
  } else if(i % 3 === 0){
    console.log('dev');
  } else if(i % 5 === 0){
